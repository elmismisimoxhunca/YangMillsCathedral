...
- Author(s): C. N. Yang and R. L. Mills.
- Publication: Physical Review 96 (1954), 191–195.
- Identifier: 10.1103/PhysRev.96.191.
- Retained PDF: `isotopic_spin_gauge_invariance.pdf` (5 PDF pages).
- Exact native extraction: `isotopic_spin_gauge_invariance.txt`, produced with `pdftotext -layout`.

## Audit role

Historical non-Abelian gauge-field source; modern bundle semantics remain sourced to geometric references.
