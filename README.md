...
derived fiberwise-linear overlap formulas with proved model-coordinate smoothness, and a named
covering quotient chart atlas with explicit tangent-model transport, alongside an explicit positive
adjoint-invariant
