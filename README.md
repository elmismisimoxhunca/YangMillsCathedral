...
certificate type and semantics, the fiberwise torsor core of a principal bundle, and algebraic
bundle maps/gauge automorphisms are implemented. No concrete gauge-group witness, symmetry group,
smooth principal-bundle/local-triviality layer, connection or curvature, reconstruction bridge,
