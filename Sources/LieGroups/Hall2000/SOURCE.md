...
unitarization consequence of Proposition 5.17 without asserting Peter–Weyl completeness. A separate
...
consequence identified after Proposition 5.17. Each selected simple group-algebra summand is now
reconciled with Mathlib's scalar-restricted `ofModule` carrier, supplied an exact finite basis and
