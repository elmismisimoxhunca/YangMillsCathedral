...
- Publication: Communications in Mathematical Physics 141 (1991), 153–209.
- Identifier: 10.1007/BF02100009.
- Retained PDF: `quantum_gauge_theories_two_dimensions.pdf` (57 PDF pages).
- Exact native extraction: `quantum_gauge_theories_two_dimensions.txt`, produced with `pdftotext -layout`.

## Audit role

Physical/geometric cross-check for exact two-dimensional formulas; not the sole rigorous construction source.
