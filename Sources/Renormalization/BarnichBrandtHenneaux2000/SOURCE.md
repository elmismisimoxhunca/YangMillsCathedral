...
- Author(s): Glenn Barnich, Friedemann Brandt, and Marc Henneaux.
- Publication: Physics Reports 338 (2000), 439–569.
- Identifier: 10.1016/S0370-1573(00)00049-1.
- Retained PDF: `local_brst_cohomology.pdf` (131 PDF pages).
- Exact native extraction: `local_brst_cohomology.txt`, produced with `pdftotext -layout`.

## Audit role

Authoritative review for curvature/covariant-derivative local grammar and distinctions among invariance, BRST classes, total derivatives, and on-shell equivalence.
