...
- [x] Transport that action to both real selected-loop coefficient components, use positive-time
  ...
  uniform closure of the continuous coefficient-core image without assuming density, prove that the
  still-open graph-density field alone would extend this zeroth-order continuity to every smooth
