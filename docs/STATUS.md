...
- The living audit is now anchored to fully validated implementation commit `8087ba8` on branch
  `cathedral`: 3,649 build jobs, 6,937 kernel-audited declarations, 486 Lean files, a then-clean
