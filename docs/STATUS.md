...
- The living audit is now anchored to fully validated implementation commit `42eea05` on branch
  `cathedral`: 3,639 build jobs, 6,864 kernel-audited declarations, 476 Lean files, a then-clean
