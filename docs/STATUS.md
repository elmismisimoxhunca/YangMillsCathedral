...
- The living audit is now anchored to fully validated implementation commit `771f242` on branch
  `cathedral`: 3,751 build jobs, 7,614 kernel-audited declarations, 588 Lean files, a then-clean
