...
- The living audit is now anchored to fully validated implementation commit `ea42243` on branch
  `cathedral`: 3,695 build jobs, 7,188 kernel-audited declarations, 532 Lean files, a then-clean
