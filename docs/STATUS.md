...
- The living audit is now anchored to fully validated implementation commit `18c4636` on branch
  `cathedral`: 3,691 build jobs, 7,167 kernel-audited declarations, 528 Lean files, a then-clean
