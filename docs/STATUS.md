...
- The living audit is now anchored to fully validated implementation commit `f6a4c0c` on branch
  `cathedral`: 3,697 build jobs, 7,206 kernel-audited declarations, 534 Lean files, a then-clean
