...
- The living audit is now anchored to fully validated implementation commit `e3abbca` on branch
  `cathedral`: 3,615 build jobs, 6,657 kernel-audited declarations, 452 Lean files, a then-clean
