...
- The living audit is now anchored to fully validated implementation commit `d35f7f9` on branch
  `cathedral`: 3,723 build jobs, 7,412 kernel-audited declarations, 560 Lean files, a then-clean
