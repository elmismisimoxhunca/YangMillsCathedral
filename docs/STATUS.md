...
- The living audit is now anchored to fully validated implementation commit `6629dfb` on branch
  `cathedral`: 3,641 build jobs, 6,874 kernel-audited declarations, 478 Lean files, a then-clean
