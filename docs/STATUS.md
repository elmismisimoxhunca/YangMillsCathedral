...
- The living audit is now anchored to fully validated implementation commit `e272399` on branch
  `cathedral`: 3,709 build jobs, 7,358 kernel-audited declarations, 546 Lean files, a then-clean
