...
- The living audit is now anchored to fully validated implementation commit `3acd92e` on branch
  `cathedral`: 3,721 build jobs, 7,405 kernel-audited declarations, 558 Lean files, a then-clean
