...
- The living audit is now anchored to fully validated implementation commit `661f044` on branch
  `cathedral`: 3,657 build jobs, 6,996 kernel-audited declarations, 494 Lean files, a then-clean
