...
- The living audit is now anchored to fully validated implementation commit `708a36e` on branch
  `cathedral`: 3,715 build jobs, 7,380 kernel-audited declarations, 552 Lean files, a then-clean
