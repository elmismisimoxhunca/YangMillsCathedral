...
- The living audit is now anchored to fully validated implementation commit `9a38fba` on branch
  `cathedral`: 3,633 build jobs, 6,821 kernel-audited declarations, 470 Lean files, a then-clean
