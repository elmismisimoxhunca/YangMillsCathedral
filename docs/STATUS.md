...
- The living audit is now anchored to fully validated implementation commit `92fad89` on branch
  `cathedral`: 3,645 build jobs, 6,920 kernel-audited declarations, 482 Lean files, a then-clean
