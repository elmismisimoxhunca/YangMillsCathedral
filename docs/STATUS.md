...
- The living audit is now anchored to fully validated implementation commit `3563f08` on branch
  `cathedral`: 3,669 build jobs, 7,054 kernel-audited declarations, 506 Lean files, a then-clean
