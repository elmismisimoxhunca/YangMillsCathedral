...
- The living audit is now anchored to fully validated implementation commit `32cd5df` on branch
  `cathedral`: 3,659 build jobs, 7,010 kernel-audited declarations, 496 Lean files, a then-clean
