...
- The living audit is now anchored to fully validated implementation commit `b8cdafc` on branch
  `cathedral`: 3,647 build jobs, 6,926 kernel-audited declarations, 484 Lean files, a then-clean
