...
- The living audit is now anchored to fully validated implementation commit `da312fb` on branch
  `cathedral`: 3,745 build jobs, 7,583 kernel-audited declarations, 582 Lean files, a then-clean
