...
- The living audit is now anchored to fully validated implementation commit `86ad396` on branch
  `cathedral`: 3,747 build jobs, 7,596 kernel-audited declarations, 584 Lean files, a then-clean
