...
- The living audit is now anchored to fully validated implementation commit `16b255f` on branch
  `cathedral`: 3,687 build jobs, 7,150 kernel-audited declarations, 524 Lean files, a then-clean
