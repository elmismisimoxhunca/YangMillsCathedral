...
- The living audit is now anchored to fully validated implementation commit `97717af` on branch
  `cathedral`: 3,733 build jobs, 7,514 kernel-audited declarations, 570 Lean files, a then-clean
