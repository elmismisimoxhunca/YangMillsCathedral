...
- The living audit is now anchored to fully validated implementation commit `48c3a50` on branch
  `cathedral`: 3,629 build jobs, 6,800 kernel-audited declarations, 466 Lean files, a then-clean
