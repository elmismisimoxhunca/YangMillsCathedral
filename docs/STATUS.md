...
- The living audit is now anchored to fully validated implementation commit `2180cb1` on branch
  `cathedral`: 3,673 build jobs, 7,068 kernel-audited declarations, 510 Lean files, a then-clean
