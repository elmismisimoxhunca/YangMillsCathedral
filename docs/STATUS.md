...
- The living audit is now anchored to fully validated implementation commit `f290bef` on branch
  `cathedral`: 3,625 build jobs, 6,763 kernel-audited declarations, 462 Lean files, a then-clean
