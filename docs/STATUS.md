...
- The living audit is now anchored to fully validated implementation commit `0395e91` on branch
  `cathedral`: 3,713 build jobs, 7,366 kernel-audited declarations, 550 Lean files, a then-clean
