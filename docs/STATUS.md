...
- The living audit is now anchored to fully validated implementation commit `cbafb6f` on branch
  `cathedral`: 3,697 build jobs, 7,209 kernel-audited declarations, 534 Lean files, a then-clean
