...
- The living audit is now anchored to fully validated implementation commit `64107b1` on branch
  `cathedral`: 3,635 build jobs, 6,829 kernel-audited declarations, 472 Lean files, a then-clean
