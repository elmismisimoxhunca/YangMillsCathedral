...
- The living audit is now anchored to fully validated implementation commit `9c1714f` on branch
  `cathedral`: 3,613 build jobs, 6,643 kernel-audited declarations, 450 Lean files, a then-clean
