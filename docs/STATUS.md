...
- The living audit is now anchored to fully validated implementation commit `0e20123` on branch
  `cathedral`: 3,759 build jobs, 7,657 kernel-audited declarations, 596 Lean files, a then-clean
