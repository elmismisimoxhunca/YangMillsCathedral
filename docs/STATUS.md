...
- The living audit is now anchored to fully validated implementation commit `78bdc3b` on branch
  `cathedral`: 3,637 build jobs, 6,843 kernel-audited declarations, 474 Lean files, a then-clean
