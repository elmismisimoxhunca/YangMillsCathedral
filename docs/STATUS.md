...
- The living audit is now anchored to fully validated implementation commit `27c18b4` on branch
  `cathedral`: 3,619 build jobs, 6,704 kernel-audited declarations, 456 Lean files, a then-clean
