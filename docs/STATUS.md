...
- The living audit is now anchored to fully validated implementation commit `4a03daa` on branch
  `cathedral`: 3,607 build jobs, 6,590 kernel-audited declarations, 444 Lean files, a then-clean
