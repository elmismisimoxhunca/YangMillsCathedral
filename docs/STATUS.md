...
- The living audit is now anchored to fully validated implementation commit `ecf4a7b` on branch
  `cathedral`: 3,601 build jobs, 6,535 kernel-audited declarations, 438 Lean files, a then-clean
