...
- The living audit is now anchored to fully validated implementation commit `33fb8e4` on branch
  `cathedral`: 3,701 build jobs, 7,263 kernel-audited declarations, 538 Lean files, a then-clean
