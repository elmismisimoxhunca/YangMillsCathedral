...
- The living audit is now anchored to fully validated implementation commit `1f8980d` on branch
  `cathedral`: 3,611 build jobs, 6,627 kernel-audited declarations, 448 Lean files, a then-clean
