...
- The living audit is now anchored to fully validated implementation commit `a540ec7` on branch
  `cathedral`: 3,761 build jobs, 7,672 kernel-audited declarations, 598 Lean files, a then-clean
