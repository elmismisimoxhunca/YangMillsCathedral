...
- The living audit is now anchored to fully validated implementation commit `f189b2a` on branch
  `cathedral`: 3,651 build jobs, 6,963 kernel-audited declarations, 488 Lean files, a then-clean
