...
- The living audit is now anchored to fully validated implementation commit `7da96a3` on branch
  `cathedral`: 3,679 build jobs, 7,101 kernel-audited declarations, 516 Lean files, a then-clean
