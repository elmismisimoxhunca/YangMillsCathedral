...
- The living audit is now anchored to fully validated implementation commit `36585f3` on branch
  `cathedral`: 3,603 build jobs, 6,539 kernel-audited declarations, 440 Lean files, a then-clean
