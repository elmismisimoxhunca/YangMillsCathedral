...
- The living audit is now anchored to fully validated implementation commit `3f0c5d3` on branch
  `cathedral`: 3,735 build jobs, 7,540 kernel-audited declarations, 572 Lean files, a then-clean
