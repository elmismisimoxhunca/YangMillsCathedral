...
- The living audit is now anchored to fully validated implementation commit `b7fa91f` on branch
  `cathedral`: 3,595 build jobs, 6,506 kernel-audited declarations, 432 Lean files, a then-clean
