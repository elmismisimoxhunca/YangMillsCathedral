...
- The living audit is now anchored to fully validated implementation commit `7f4393c` on branch
  `cathedral`: 3,671 build jobs, 7,064 kernel-audited declarations, 508 Lean files, a then-clean
