...
- The living audit is now anchored to fully validated implementation commit `c378e4f` on branch
  `cathedral`: 3,703 build jobs, 7,274 kernel-audited declarations, 540 Lean files, a then-clean
