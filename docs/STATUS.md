...
- The living audit is now anchored to fully validated implementation commit `8088534` on branch
  `cathedral`: 3,677 build jobs, 7,080 kernel-audited declarations, 514 Lean files, a then-clean
