...
- The living audit is now anchored to fully validated implementation commit `c8cc0ba` on branch
  `cathedral`: 3,705 build jobs, 7,285 kernel-audited declarations, 542 Lean files, a then-clean
