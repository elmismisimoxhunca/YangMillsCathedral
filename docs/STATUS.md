...
- The living audit is now anchored to fully validated implementation commit `6e8800d` on branch
  `cathedral`: 3,665 build jobs, 7,038 kernel-audited declarations, 502 Lean files, a then-clean
