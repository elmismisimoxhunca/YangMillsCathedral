...
- The living audit is now anchored to fully validated implementation commit `51b890b` on branch
  `cathedral`: 3,737 build jobs, 7,543 kernel-audited declarations, 574 Lean files, a then-clean
