...
- The living audit is now anchored to fully validated implementation commit `5d41334` on branch
  `cathedral`: 3,621 build jobs, 6,715 kernel-audited declarations, 458 Lean files, a then-clean
