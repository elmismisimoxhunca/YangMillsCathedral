...
- The living audit is now anchored to fully validated implementation commit `8ff2059` on branch
  `cathedral`: 3,627 build jobs, 6,786 kernel-audited declarations, 464 Lean files, a then-clean
