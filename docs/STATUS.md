...
- The living audit is now anchored to fully validated implementation commit `b2a3e47` on branch
  `cathedral`: 3,739 build jobs, 7,552 kernel-audited declarations, 576 Lean files, a then-clean
