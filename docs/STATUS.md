...
- The living audit is now anchored to fully validated implementation commit `a614b16` on branch
  `cathedral`: 3,655 build jobs, 6,973 kernel-audited declarations, 492 Lean files, a then-clean
