...
- The living audit is now anchored to fully validated implementation commit `a3a28b2` on branch
  `cathedral`: 3,643 build jobs, 6,905 kernel-audited declarations, 480 Lean files, a then-clean
