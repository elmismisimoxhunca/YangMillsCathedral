...
- The living audit is now anchored to fully validated implementation commit `3d0f169` on branch
  `cathedral`: 3,597 build jobs, 6,523 kernel-audited declarations, 434 Lean files, a then-clean
