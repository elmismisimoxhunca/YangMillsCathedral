...
- The living audit is now anchored to fully validated implementation commit `c0ddd3d` on branch
  `cathedral`: 3,663 build jobs, 7,021 kernel-audited declarations, 500 Lean files, a then-clean
