...
- The living audit is now anchored to fully validated implementation commit `1cc5a6e` on branch
  `cathedral`: 3,705 build jobs, 7,278 kernel-audited declarations, 542 Lean files, a then-clean
