...
- The living audit is now anchored to fully validated implementation commit `b518a57` on branch
  `cathedral`: 3,623 build jobs, 6,742 kernel-audited declarations, 460 Lean files, a then-clean
