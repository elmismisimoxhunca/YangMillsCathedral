...
- The living audit is now anchored to fully validated implementation commit `a1fbb6f` on branch
  `cathedral`: 3,631 build jobs, 6,813 kernel-audited declarations, 468 Lean files, a then-clean
