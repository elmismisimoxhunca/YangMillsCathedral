...
| Dimension 2 consistency | Kinematic/gauge-fixed/selected-loop layers; normalized-Haar convolution semigroup; pairing Laplacian; same-density heat equation; rigorous 2D sources | Exact restriction and expectation; normalization/convolution/weak identity; actual right-field `mfderiv`, nonempty orthonormal basis and all-basis coherence; positive smooth real bridge and exact `∂ₜQ=½ΔQ` | Partial | No density, PDE solution, Brownian/martingale generator, or invariant-pairing manifold metric is constructed. No rigorous YM measure or planar loop geometry; general face/refinement products, compact-surface gluing, and lattice convergence remain absent; no 2D result may inhabit 4D |
...
7. **Dimension contracts:** the 2D gauge-fixed nucleus, selected-loop normalized-Haar density
   ...
   Brownian/martingale generator and pairing-to-manifold-metric bridges, planar geometry, general
   face/refinement, projective/gluing, and
