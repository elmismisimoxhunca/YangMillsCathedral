...
| `python3 scripts/verify_sources.py` | PASS, 14 manifests | Retained artifact bytes match manifests | That a source is authoritative, correctly read, or sufficient for a declaration |
